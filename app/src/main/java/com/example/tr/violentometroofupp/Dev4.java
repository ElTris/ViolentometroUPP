...
public class Dev4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri uri = Uri.parse("https://www.facebook.com/mauricio.zavala.790");
        ...
        twitter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://twitter.com/Maurici27112668");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://www.instagram.com/tuzoo_mauux/");
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
...
// Esto podrás modificarlo si quieres, el asunto y el cuerpo del mensaje
        ...
        try {
            ...
            Toast.makeText(Dev4.this, "No tienes clientes de email instalados.", Toast.LENGTH_SHORT).show();
        }
    }
}
